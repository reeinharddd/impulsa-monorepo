...
@Component({
  ...
  `,
  styles: [`
    .history-container { padding: 1rem; max-width: 800px; margin: 0 auto; }
    ...
    .intent-info { display: flex; flex-direction: column; }
    .reference { font-weight: 600; font-size: 1rem; }
    .date { font-size: 0.8rem; color: #6b7280; }
    .intent-amount { text-align: right; display: flex; flex-direction: column; align-items: flex-end; }
    .amount { font-weight: 700; }
    .status { font-size: 0.75rem; padding: 2px 6px; border-radius: 4px; margin-top: 4px; display: inline-block; }

    .status.CONFIRMED { background: #dcfce7; color: #166534; }
    .status.CREATED { background: #eff6ff; color: #1e40af; }
