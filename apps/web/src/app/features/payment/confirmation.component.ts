...
@Component({
  ...
  styles: [`
    ...
    .success-icon {
        ...
        border-radius: 50%; font-size: 2rem; line-height: 60px; margin: 0 auto 1rem;
    }
    h2 { margin-bottom: 0.5rem; color: #166534; }
    .subtitle { color: #6b7280; margin-bottom: 2rem; }

    .details { background: #f9fafb; padding: 1rem; border-radius: 8px; margin-bottom: 2rem; }
    ...
    .btn-primary {
        ...
        text-decoration: none; padding: 1rem; border-radius: 8px; font-weight: 600;
    }
  `]
})
